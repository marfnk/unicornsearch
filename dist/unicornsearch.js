    ...
    return {
      ...
      link: function ($scope, element, attrs, ngModel) {
        ...
        function handleKeyboardInput(event) {
          ...
          var backspace = 8, down = 40, up = 38, esc = 27, enter = 13;
          ...
          } else if (pressed === backspace && inputIsEmpty()) {
